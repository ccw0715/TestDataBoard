...
const WORK_ORDER_CATEGORIES = {
  ...
  non_repair: { label: '非维修类', icon: '📋', color: '#5b8dd9', bg: '#e8f0fb', desc: '咨询/投诉/建议等' },
};
...
const RAW_WORK_ORDERS = [
  ...
  { id: 'WO002', projectId: 'P001', issue: '停车费用收取标准疑问', category: 'non_repair', attitude: '态度良好', valid: true, handler: '王客服', completed: true, deadline: '2025-08-02', handleTime: 1.2, overdue: false, satisfied: true },
  { id: 'WO003', projectId: 'P001', issue: '保洁人员态度恶劣，言语冲突', category: 'non_repair', attitude: '态度恶劣', valid: true, handler: '陈主管', completed: true, deadline: '2025-08-02', handleTime: 8.0, overdue: true, satisfied: false },
  ...
  { id: 'WO005', projectId: 'P001', issue: '小区绿化养护问题反映', category: 'non_repair', attitude: '态度良好', valid: false, handler: '王客服', completed: true, deadline: '2025-08-04', handleTime: 2.0, overdue: false, satisfied: true },
  ...
  { id: 'WO007', projectId: 'P002', issue: '物业费计算规则咨询', category: 'non_repair', attitude: '态度良好', valid: true, handler: '陈客服', completed: true, deadline: '2025-08-02', handleTime: 0.8, overdue: false, satisfied: true },
  { id: 'WO008', projectId: 'P002', issue: '安保人员不文明执勤投诉', category: 'non_repair', attitude: '态度恶劣', valid: true, handler: '刘主管', completed: false, deadline: '2025-08-04', handleTime: null, overdue: true, satisfied: null },
  ...
  { id: 'WO010', projectId: 'P003', issue: '消防设施检查询问', category: 'non_repair', attitude: '态度良好', valid: true, handler: '王客服', completed: true, deadline: '2025-08-02', handleTime: 1.5, overdue: false, satisfied: true },
  { id: 'WO011', projectId: 'P003', issue: '停车位划分不合理投诉', category: 'non_repair', attitude: '态度良好', valid: true, handler: '陈主管', completed: true, deadline: '2025-08-03', handleTime: 5.0, overdue: false, satisfied: true },
  ...
  { id: 'WO013', projectId: 'P004', issue: '装修管理规定咨询', category: 'non_repair', attitude: '态度良好', valid: true, handler: '王客服', completed: true, deadline: '2025-08-01', handleTime: 0.5, overdue: false, satisfied: true },
  { id: 'WO014', projectId: 'P004', issue: '楼上噪音扰民投诉', category: 'non_repair', attitude: '态度良好', valid: true, handler: '刘主管', completed: true, deadline: '2025-08-03', handleTime: 4.0, overdue: false, satisfied: true },
  ...
  { id: 'WO016', projectId: 'P005', issue: '车辆被贴条咨询', category: 'non_repair', attitude: '态度恶劣', valid: false, handler: '陈客服', completed: true, deadline: '2025-08-03', handleTime: 1.0, overdue: false, satisfied: false },
  { id: 'WO017', projectId: 'P005', issue: '消防通道被占用投诉（业主反映）', category: 'non_repair', attitude: '态度良好', valid: true, handler: '刘主管', completed: false, deadline: '2025-08-04', handleTime: null, overdue: true, satisfied: null },
  ...
  { id: 'WO019', projectId: 'P005', issue: '绿化破坏赔偿标准咨询', category: 'non_repair', attitude: '态度良好', valid: true, handler: '王客服', completed: true, deadline: '2025-08-04', handleTime: 2.0, overdue: false, satisfied: true },
...
function getWorkOrders() {
  try {
    const stored = localStorage.getItem('tdb_workorders_v2');
    if (stored) return JSON.parse(stored);
  } catch(e) {}
...
function saveWorkOrders(list) {
  localStorage.setItem('tdb_workorders_v2', JSON.stringify(list));
}
